...
<form action="회원가입_progress.jsp" method="post">
...
능력: <input type="checkbox" name="magic1" value="신화능력" checked>신화능력
<input type = "checkbox" name="magic2" value="자연능력">자연능력
<input type = "checkbox" name="magic3" value="인조능력">인조능력
<p>
